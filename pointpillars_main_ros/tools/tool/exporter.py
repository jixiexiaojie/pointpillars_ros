...
def parse_config():
    ...
    parser.add_argument('--cfg_file', type=str, default='cfgs/custom_models/pointpillar_duo.yaml', help='specify the config for demo')
    parser.add_argument('--data_path', type=str, default='../data', help='specify the point cloud data file or directory')
    parser.add_argument('--ckpt', type=str, default='./ckpt/checkpoint_epoch_300.pth', help='specify the pretrained model')
