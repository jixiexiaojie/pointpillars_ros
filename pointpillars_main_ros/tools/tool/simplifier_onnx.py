...
def simplify_postprocess(onnx_model):
  ...
  # cls_preds = gs.Variable(name="cls_preds", dtype=np.float32, shape=(1, 248, 432, 18))
  # box_preds = gs.Variable(name="box_preds", dtype=np.float32, shape=(1, 248, 432, 42))
  # dir_cls_preds = gs.Variable(name="dir_cls_preds", dtype=np.float32, shape=(1, 248, 432, 12))
